...
file_path = r"C:\Users\Administrator\.openclaw\workspace\Pallavi_Srivastava_ATS_Icons_Centered_OnePage.pdf"

styles = getSampleStyleSheet()
style_name = ParagraphStyle('name', parent=styles['Heading1'], fontSize=16, alignment=TA_CENTER, spaceAfter=4)
style_contact = ParagraphStyle('contact', parent=styles['Normal'], fontSize=10, alignment=TA_CENTER, spaceAfter=8)
style_heading = ParagraphStyle('heading', parent=styles['Heading2'], fontSize=11, spaceBefore=6, spaceAfter=3)
style_body = ParagraphStyle('body', parent=styles['Normal'], fontSize=9.5, leading=12)
style_role = ParagraphStyle('role', parent=styles['Normal'], fontSize=9.5, leading=12, spaceBefore=2, spaceAfter=1)
...
doc = SimpleDocTemplate(file_path, pagesize=A4, rightMargin=36, leftMargin=36, topMargin=30, bottomMargin=30)
doc.build(story)
print(file_path)
