...
"tailored solutions to meet complex client needs. Poised to leverage expertise in market expansion, CRM-based pipeline development, "
"and cross-functional collaboration to drive sustainable growth in a dynamic B2B sales environment. Passionate about bringing "
"innovative sales strategies to new challenges and contributing to a high-performing sales team."
)

experiences = [
    (
        "Business Development Executive – Ziff Davis, Performance Marketing",
        "Aug 2025 – Jan 2026",
        [
    ...
    (
        "Sales Development Representative – Unbound B2B",
        "Mar 2025 – Jul 2025",
        [
    ...
    (
        "Senior Business Development Associate – Scaler",
        "May 2022 – Jan 2024",
        [
    ...
    (
        "Senior Business Development Associate – Planet Spark",
        "Jan 2021 – Apr 2022",
        [
    ...
    (
        "Sales Associate – The Times of India",
        "Jul 2020 – Dec 2020",
        [
...
file_path = r"C:\Users\Administrator\.openclaw\workspace\Pallavi_Srivastava_Updated.pdf"

styles = getSampleStyleSheet()
style_title = ParagraphStyle('title', parent=styles['Heading1'], fontSize=16, spaceAfter=6)
style_sub = ParagraphStyle('sub', parent=styles['Normal'], fontSize=10, textColor=colors.grey)
style_heading = ParagraphStyle('heading', parent=styles['Heading2'], fontSize=12, spaceBefore=12, spaceAfter=6)
style_body = ParagraphStyle('body', parent=styles['Normal'], fontSize=10, leading=14)

story = []
story.append(Paragraph(name, style_title))
story.append(Paragraph(contact, style_sub))
...
for title, dates, bullets in experiences:
    story.append(Paragraph(f"<b>{title}</b> — {dates}", style_body))
    for b in bullets:
