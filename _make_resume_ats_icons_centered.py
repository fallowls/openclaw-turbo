...
contact = "✉︎ pallavisrivastava0507@gmail.com   |   ☎︎ 6395934465"
...
file_path = r"C:\Users\Administrator\.openclaw\workspace\Pallavi_Srivastava_ATS_Icons_Centered.pdf"

styles = getSampleStyleSheet()
style_name = ParagraphStyle('name', parent=styles['Heading1'], fontSize=16, alignment=TA_CENTER, spaceAfter=4)
style_contact = ParagraphStyle('contact', parent=styles['Normal'], fontSize=10, alignment=TA_CENTER, spaceAfter=10)
